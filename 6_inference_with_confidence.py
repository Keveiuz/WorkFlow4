...
@dataclass
class LLMConfig():
    model: str = "/workspace/mnt/lxb_work/zez_work/Boundary-Sample/model/bottom_percent_group_confidence-bottom_20K"
...
@dataclass
class DataConfig():
    input_file: str = "/workspace/mnt/lxb_work/zez_work/Boundary-Sample/temp/guardreasoner-filtered.jsonl"
    output_file: str = "/workspace/mnt/lxb_work/zez_work/Boundary-Sample/temp/guardreasoner-reinference.jsonl"
    temp_path: str = "/workspace/mnt/lxb_work/zez_work/Boundary-Sample/temp/sft-model-20K-bottom"
